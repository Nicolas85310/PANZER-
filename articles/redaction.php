...
if(isset($_POST['article_titre'], $_POST['article_tank'], $_POST['article_contenu'])) {
   if(!empty($_POST['article_titre']) AND !empty($_POST['article_tank']) AND !empty($_POST['article_contenu'])) {
      ...
      $ins = $bdd->prepare('INSERT INTO article (Login, titre, Type_de_Tank, Article_Texte, Date_Publication, ID_Utilisateur, ID_Periode, approuve, miniature, videos) VALUES (?, ?, ?, ?, CURDATE(), ?, "1", "0", ?, ?)');
