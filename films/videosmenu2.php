...
$articles = $bdd->query('SELECT * FROM article WHERE ID_Periode = "2" ORDER BY Date_Publication DESC');
?>
<!DOCTYPE html>
<html>
<head>
   <title>videosmenu2</title>
   <meta charset="utf-8">
...
<p><a href="../index/connected.php" class="lien">PAGE D'ACCUEIL</a>
   ...
   <source src="../articles/videos/<?= $a['ID_Article'] ?>.mp4" type="video/mp4" />
   <source src="../articles/videos/<?= $a['ID_Article'] ?>.avi" type="video/avi" />
